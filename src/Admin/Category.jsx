...
const Category = () => {
    ...
    const handleAddCategory = async () => {
        const res = await axios.post(`${api}/PropertyCategoryTbls`, { categoryName: category })
        if (res) {
            getAllCategories()
        }
    };
  ...
  const handleEditCategory = async () => {
    const res = await axios.put(`${api}/PropertyCategoryTbls/${editIndex}`,{categoryName: editValue})
    if(res){
        getAllCategories()
    }
